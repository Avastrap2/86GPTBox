...
enum {
    ...
    NE2K_IBM_VALUEPOINT     = 7, /* 16-bit ISA IBM PS/ValuePoint Ethernet Adapter */
    NE2K_RTL8019AS_PNP      = 8, /* 16-bit ISA PnP Realtek 8019AS */
    NE2K_DE220P             = 9, /* 16-bit ISA PnP D-Link DE-220P */
    NE2K_RTL8029AS          = 10, /* 32-bit PCI Realtek 8029AS */
